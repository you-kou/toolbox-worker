...
INSERT INTO "ToolOverviews" VALUES ('Ab04', 'A', 'b', '文心一言', 'https://nlp-eb.cdn.bcebos.com/static/eb/asset/logo.8a6b508d.png', '文心一言既是你的智能伙伴，可以陪你聊天、回答问题、画图识图；也是你的AI助手，可以提供灵感、撰写文案、阅读文档、智能翻译，帮你高效完成工作和学习任务。', 'https://yiyan.baidu.com/', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Ab05', 'A', 'b', '豆包', 'https://lf-flow-web-cdn.doubao.com/obj/flow-doubao/doubao/logo-doubao-overflow.png', '豆包是你的 AI 聊天智能对话问答助手，写作文案翻译情感陪伴编程全能工具。豆包为你答疑解惑，提供灵感，辅助创作，也可以和你畅聊任何你感兴趣的话题。', 'https://www.doubao.com/chat/', '', 0);
...
INSERT INTO "ToolOverviews" VALUES ('Ca01', 'C', 'a', 'cobalt', 'https://r2.lazyers.tools/logo/cobalt.png', 'Cobalt可以让你保存你喜欢的东西，而不需要广告、跟踪、付费墙或其他无用的东西。只需粘贴链接，你就可以嗨起来了！', 'https://cobalt.tools/', '免费；无广告；开源', 1);
...
INSERT INTO "ToolOverviews" VALUES ('Da01', 'D', 'a', 'Potplayer', 'https://t1.daumcdn.net/potplayer/main/img/favicon.ico', 'PotPlayer 可以说是当今 Windows 平台上功能最强大的多媒体播放器（之一？），无广告，不流氓，界面简洁，纯粹为播放而生！', 'https://potplayer.daum.net/?lang=zh_CN', '无广告；界面简洁；功能强大', 1);
...
INSERT INTO "ToolOverviews" VALUES ('Da06', 'D', 'a', 'Snipaste', 'https://www.snipaste.com/img/logo.svg', 'Snipaste‌是一个简单但功能强大的截图工具，它允许用户将截图贴回到屏幕上，并进行各种自定义操作。Snipaste的主要功能包括截图、贴图、图片编辑和标注等。', 'https://www.snipaste.com', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Da07', 'D', 'a', '迅雷', 'https://www.xunlei.com/icons/logo.svg', '迅雷是迅雷公司开发的一款基于多资源超线程技术的下载软件，作为“宽带时期的下载工具”，迅雷针对宽带用户做了优化，并同时推出了“智能下载”的服务。迅雷利用多资源超线程技术基于网格原理，能将网络上存在的服务器和计算机资源进行整合，构成迅雷网络，通过迅雷网络各种数据文件能够传递。多资源超线程技术还具有互联网下载负载均衡功能，在不降低用户体验的前提下，迅雷网络可以对服务器资源进行均衡。', 'https://www.xunlei.com/', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Da08', 'D', 'a', '百度网盘', 'https://nd-static.bdstatic.com/m-static/wp-brand/favicon.ico', '百度网盘（原百度云）是百度推出的一项云存储服务，已覆盖主流PC和手机操作系统，包含Web版、Windows版、Mac版、Android版、Linux信创版、青春版、TV版、iPhone版和iPad版，并覆盖了主流联网车和非联网车。', 'https://pan.baidu.com/download', '', 0);
...
INSERT INTO "ToolOverviews" VALUES ('Eb01', 'E', 'b', 'Vue.js', 'https://cn.vuejs.org/logo.svg', '渐进式的 JavaScript 框架。', 'https://cn.vuejs.org/', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Eb02', 'E', 'b', 'Vue Router', 'https://router.vuejs.org/logo.png', 'Vue.js 的官方路由。', 'https://router.vuejs.org/', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Eb03', 'E', 'b', 'Pinia', 'https://pinia.vuejs.org/logo.svg', '符合直觉的 Vue.js 状态管理库。', 'https://pinia.vuejs.org/', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Eb04', 'E', 'b', 'Pinia 插件 Persistedstate', 'https://prazdevs.github.io/pinia-plugin-persistedstate/favicon.ico', '可配置的 Pinia 存储持久化。', 'https://prazdevs.github.io/pinia-plugin-persistedstate', 'Pinia 插件', 0);
INSERT INTO "ToolOverviews" VALUES ('Eb05', 'E', 'b', 'Axios', 'https://www.axios-http.cn/img/favicon.ico', 'Axios 是一个基于 promise 的网络请求库，可以用于浏览器和 node.js。', 'https://www.axios-http.cn/', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Eb06', 'E', 'b', 'Element Plus', 'https://element-plus.org/images/element-plus-logo-small.svg', '基于 Vue 3，面向设计师和开发者的组件库。', 'https://element-plus.org/', 'UI', 0);
INSERT INTO "ToolOverviews" VALUES ('Eb07', 'E', 'b', 'vue-clipboard2', '', 'vue-clipboard2 是一个基于 Vue.js 的剪贴板操作插件，允许开发者轻松实现文本复制到剪贴板的功能。它封装了原生的 Clipboard API，提供了简单易用的指令和方法。', 'https://vue-clipboard2.inndy.tw/', '剪贴板', 0);

INSERT INTO "ToolOverviews" VALUES ('Ec01', 'E', 'c', 'Git', 'https://git-scm.com/favicon.ico', 'Git（读音为/gɪt/）是一个开源的分布式版本控制系统，可以有效、高速地处理从很小到非常大的项目版本管理。', 'https://git-scm.com/', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Ec02', 'E', 'c', 'Ping检测', 'https://csstools.chinaz.com/favicon.ico', '通过该工具可以多个地点Ping服务器以检测服务器响应速度。', 'https://ping.chinaz.com/', '', 0);
INSERT INTO "ToolOverviews" VALUES ('Ec03', 'E', 'c', '端口扫描', 'https://csstools.chinaz.com/favicon.ico', '通过该工具可以扫描常用的端口和指定的端口是否开放。', 'https://tool.chinaz.com/port/', '', 0);
...
-- 网络资源
-- ----------------------------
INSERT INTO "ToolCategorys" VALUES ('G', '网盘资源');

INSERT INTO "ToolSubcategorys" VALUES ('G', 'a', '纪录片');

INSERT INTO "ToolOverviews" VALUES ('Ga01', 'G', 'a', '被数学选中的人', 'https://r2.lazyers.tools/logo/被数学选中的人.jpg', '本片从数学与人的关系出发，介绍数学作为最基础学科对于人类文明进程的意义。通过现实生活中数学的体现，如计时、建筑、音乐、天气预报等，介绍数学的应用。同时，通过对数学家的访谈，了解这些“被数学选中的人”是如何看待数学、看待科学演进的。', 'https://www.alipan.com/s/qH8RDjmu1uJ', '', 0);
